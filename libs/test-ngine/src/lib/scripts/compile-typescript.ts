...
export function createProgram(param1, options) {
...
export function createCompilerHost(options, sourceString) {
  return {
...
export function getDiagnostics(program, printDiagnostics = false) {
