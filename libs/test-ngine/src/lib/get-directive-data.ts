import { getImportLib, reIndent } from './scripts/util.js';
import * as path from 'path';
import windowObjects from './scripts/window-objects.js';

export function getDirectiveData(tsParsed, filePath, angularType) {
  let result = {
